...
class CustomerCareController extends Controller
{
    ...
    public function storeLead(Request $request)
    {
        $request->validate([
            ...
            'agama_klien'         => 'nullable|string|max:50',
        ...
        try {
            $lead = \App\Models\Lead::create([
                ...
                'agama_klien'     => $request->agama_klien,
    ...
    public function updateLead(Request $request, $id)
    {
        ...
        try {
            $lead->update([
                ...
                'agama_klien'     => $request->has('agama_klien') ? $request->agama_klien : $lead->agama_klien,
    ...
    public function duplicateLeadForNewOrder(Request $request, $id)
    {
        ...
        try {
            $new = \App\Models\Lead::create([
                ...
                'agama_klien'            => $source->agama_klien,

...
class Lead extends Model
{
    ...
    // 4 = stop (kontrak selesai pakai jasa, bisa Lanjutkan kembali ke Proses dgn nomor+data sama)
    ...
    // E-Ticket Order Deal, dibuat sekali saat lead ditandai Deal. Format: T-LD.MGM.02.00001.
    public static function generateNomorDeal(): string
    {
        $count = self::whereNotNull('nomor_deal')->count() + 1;
        return 'T-LD.MGM.02.' . str_pad($count, 5, '0', STR_PAD_LEFT);
    }

...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('internal')->prefix('internal')->group(function () {
        ...
        Route::middleware('role:manajemen,customer_care')->prefix('cc')->group(function () {
            ...
            Route::patch('leads/{id}', [CustomerCareController::class, 'updateLead']);
            Route::patch('leads/{id}/layanan', [CustomerCareController::class, 'updateLeadLayanan']);
            ...
            Route::post('leads-exchange/{id}/tagih-transport', [CustomerCareController::class, 'tagihBiayaTransport']);
...
Route::middleware(['auth:sanctum','internal','role:manajemen,rekrutmen'])->prefix('internal/rekrutmen')->group(function () {
    ...
    Route::get('gaji-config', function () {
        return response()->json(['success'=>true,'data'=>\Illuminate\Support\Facades\DB::table('gaji_jabatan_config')->whereRaw('aktif = true')->orderBy('urutan')->get()]);
    });
